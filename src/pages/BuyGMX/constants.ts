...
const METERTEST_GMX = getContract(METERTEST, "GMX");
...
type Exchange = {
  ...
  networks: number[];
  link?: string;
  links?: { [METERTEST]: string; };
};

export const EXTERNAL_LINKS = {
  [METERTEST]: {
    bungee: `https://multitx.bungee.exchange/?toChainId=42161&toTokenAddress=${METERTEST_GMX}`,
    banxa: "https://gmx.banxa.com/?coinType=ETH&fiatType=USD&fiatAmount=500&blockchain=metertest",
    o3: "https://o3swap.com/",
    networkWebsite: "https://meter.io/",
    buyGmx: {
      banxa: "https://gmx.banxa.com/?coinType=GMX&fiatType=USD&fiatAmount=500&blockchain=metertest",
      uniswap: `https://app.uniswap.org/#/swap?inputCurrency=ETH&outputCurrency=${METERTEST_GMX}`,
    },
  },
  // [ARBITRUM]: {
