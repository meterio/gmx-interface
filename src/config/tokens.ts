  ...
  [METERTEST]: [
    {
      name: "GMX",
      symbol: "GMX",
      address: getContract(METERTEST, "GMX"),
      decimals: 18,
    ...
    },
    {
      name: "Escrowed GMX",
      symbol: "esGMX",
      address: getContract(METERTEST, "ES_GMX"),
      decimals: 18,
    },
    {
      name: "GMX LP",
      symbol: "GLP",
      address: getContract(METERTEST, "GLP"),
      decimals: 18,
...
export const PLATFORM_TOKENS: { [chainId: number]: { [symbol: string]: Token } } = {
  [METERTEST]: {
    ...
    GLP: {
      ...
      symbol: "GLP",
      decimals: 18,
      address: getContract(METERTEST, "StakedGlpTracker"), // address of fsGLP token because user only holds fsGLP
      imageUrl: "https://github.com/gmx-io/gmx-assets/blob/main/GMX-Assets/PNG/GLP_LOGO%20ONLY.png?raw=true",
    },
  },
  // [ARBITRUM]: {
...
const CHAIN_IDS = [MAINNET, METERTEST];
